...
export async function drawFileInCanvas(file) {
  // Temporarily not attempting to use 'createImageBitmap'
  // as per https://github.com/Donaldcwl/browser-image-compression/issues/118#issuecomment-925988965
